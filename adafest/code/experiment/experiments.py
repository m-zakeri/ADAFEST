...
class Visualization(object):
    ...
    def draw_heatmap_of_the_correlated_features2(self, path):
        ...
        # X.columns = metrics_names.top20_metrics
        X.columns = [str(i) for i in range(1, 21, 1)]
        ...
        # plt.colorbar()
        fig.tight_layout()
        plt.savefig(r'charts/heatmap_of_the_correlated_features_v3_fig1.png')
        plt.show()
    ...
    def draw_dataset4(self, path: str = None):
        ...
        ax = sns.scatterplot(x='CSLEX_NumberOfKeywords',
    ...
    def draw_dataset5(self, path: str = None):
        ...
        # ax.set_yticks(())
        # plt.legend(loc='upper right')
        ax.set(xlabel='CSLOCNAMM', ylabel='Coverageability')

        plt.tight_layout()
        plt.savefig(r'charts/coverageability_regression_v2_fig1.png')
        plt.show()
    ...
    def draw_dataset6(self, path: str = None):
        ...
        # ax.set_yticks(())
        # plt.legend(loc='upper right')
        ax.set(xlabel='PCA-F1', ylabel='Coverageability')
    ...
    def draw_dataset_cat_plot(self, path: str = None):
        ...
        # plt.legend(loc='upper right')
        fig.tight_layout()
        fig.savefig(r'charts/coverageability_barchart_v1_fig1.png')
        plt.show()
...
def main():
    ...
    vis = Visualization(path=ds05_path, )
